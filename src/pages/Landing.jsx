              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="mx-auto">
                  <div className="relative w-64 h-96 bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl border border-amber-500/30 overflow-hidden flex items-center justify-center">
                    {cardData.imagePath || cardData.image_url ? (
                      <img 
                        ...
                        onError={(e) => {
                          ...
                          e.target.parentElement.innerHTML = `<div class="text-center p-6"><svg class="w-16 h-16 text-amber-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path></svg><h3 class="text-xl font-serif text-amber-100">${lang === 'fr' ? cardData.name_fr : cardData.name_en}</h3></div>`;
                        }}
                      />
                    ) : (
                      <div className="text-center p-6">
                        <Star className="w-16 h-16 text-amber-400 mx-auto mb-4" />
                        <h3 className="text-xl font-serif text-amber-100">{lang === 'fr' ? cardData.name_fr : cardData.name_en}</h3>
                      </div>
                    )}
                  </div>
                </div>
